...
\begin{itemize}[leftmargin=*]
  \item Du kannst insgesamt \textbf{100 Punkte} erreichen, verteilt
    auf vier Bereiche.
...
\begin{tikzpicture}
  ...
  % Hintergrundfarben (von dunkel nach hell, gewichtet nach Punktezahl)
  \fill[maincolor]    (0,0)            rectangle (\W*0.50, \hgt);
  \fill[maincolor!72] (\W*0.50, 0)     rectangle (\W*0.70, \hgt);
  \fill[maincolor!50] (\W*0.70, 0)     rectangle (\W*0.85, \hgt);
  \fill[maincolor!32] (\W*0.85, 0)     rectangle (\W,      \hgt);
  % Beschriftungen
  \node[white, font=\bfseries]            at (\W*0.25,\hgt*0.65) {A. Pflichtfilter};
  \node[white, font=\footnotesize]        at (\W*0.25,\hgt*0.32) {50 Punkte};
  \node[white, font=\bfseries\small]      at (\W*0.60,\hgt*0.65) {B. Eigen};
  \node[white, font=\scriptsize]          at (\W*0.60,\hgt*0.32) {20 Pkt.};
  \node[white, font=\bfseries\scriptsize] at (\W*0.775,\hgt*0.65) {C. Code};
  \node[white, font=\tiny]                at (\W*0.775,\hgt*0.32) {15 Pkt.};
  \node[white, font=\bfseries\scriptsize] at (\W*0.925,\hgt*0.65) {D. Abgabe};
  \node[white, font=\tiny]                at (\W*0.925,\hgt*0.32) {15 Pkt.};
\end{tikzpicture}
\end{center}
